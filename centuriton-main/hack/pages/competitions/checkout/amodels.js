       ...
       <Grid columns={2} >
          <Grid.Row stretched>
              <Grid.Column style={{width:"70%"}}>
                <Segment>
                  <component><h1>Name of the Service : Steve Henry Model</h1></component>
                    <Grid>
            ...
            <Segment>
              <Form>
                <Form.Field>
                  ...
                  <label><h3>Demo Data Model</h3></label>
                     {/* <Input label="data" type="file" labelPosition="right" /> */}
                  </Container>
                  </Form.Field>
                   {/* <Reveal animated='fade'>
                      <Reveal.Content visible>
                       <Container style={{alignItems:"center",textAlign:"center",padding:"0",margin:"0"}}>
                         <Button transparent style={{align:"center",textAlign:"center",width:"130%",height:"200px",padding:"0",margin:"0"}}><font color="transparent"></font></Button>
                       </Container>
                      </Reveal.Content>
